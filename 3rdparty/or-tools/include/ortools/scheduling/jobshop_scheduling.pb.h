...
class Job final :
 ...
 public:
  ...
  PROTOBUF_MUST_USE_RESULT ::PROTOBUF_NAMESPACE_ID::Int64Value* release_earliest_start();
  ...
  PROTOBUF_MUST_USE_RESULT ::PROTOBUF_NAMESPACE_ID::Int64Value* release_latest_end();
...
class TransitionTimeMatrix final :
 ...
 public:
  ...
  explicit constexpr TransitionTimeMatrix(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  inline TransitionTimeMatrix* New() const final {
    return new TransitionTimeMatrix();
  }
...
class Machine final :
 ...
 public:
  ...
  ~Machine() override;
  explicit constexpr Machine(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::operations_research::scheduling::jssp::TransitionTimeMatrix* release_transition_time_matrix();
...
class JobPrecedence final :
 ...
 public:
  ...
  explicit constexpr JobPrecedence(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class JsspInputProblem final :
 ...
 public:
  ...
  explicit constexpr JsspInputProblem(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::PROTOBUF_NAMESPACE_ID::DoubleValue* release_scaling_factor();
...
class AssignedTask final :
 ...
 public:
  ...
  explicit constexpr AssignedTask(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class AssignedJob final :
 ...
 public:
  ...
  explicit constexpr AssignedJob(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class JsspOutputSolution final :
 ...
 public:
  ...
  explicit constexpr JsspOutputSolution(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline const ::operations_research::scheduling::jssp::TransitionTimeMatrix& Machine::_internal_transition_time_matrix() const {
  const ::operations_research::scheduling::jssp::TransitionTimeMatrix* p = transition_time_matrix_;
...
inline ::operations_research::scheduling::jssp::TransitionTimeMatrix* Machine::release_transition_time_matrix() {
  ...
  ::operations_research::scheduling::jssp::TransitionTimeMatrix* temp = transition_time_matrix_;
  transition_time_matrix_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline void Machine::set_allocated_transition_time_matrix(::operations_research::scheduling::jssp::TransitionTimeMatrix* transition_time_matrix) {
  ...
  if (transition_time_matrix) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::scheduling::jssp::TransitionTimeMatrix>::GetOwningArena(transition_time_matrix);
    if (message_arena != submessage_arena) {
