...
class Recipe final :
 ...
 public:
  ...
  ~Recipe() override;
  explicit constexpr Recipe(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class PerRecipeDelays final :
 ...
 public:
  ...
  explicit constexpr PerRecipeDelays(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class PerSuccessorDelays final :
 ...
 public:
  ...
  explicit constexpr PerSuccessorDelays(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class RcpspProblem final :
 ...
 public:
  ...
  explicit constexpr RcpspProblem(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_basedata();
...
void RcpspProblem::set_basedata(ArgT0&& arg0, ArgT... args) {
 ...
 basedata_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RcpspProblem::_internal_set_basedata(const std::string& value) {
  ...
  basedata_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* RcpspProblem::_internal_mutable_basedata() {
  
  return basedata_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* RcpspProblem::release_basedata() {
  ...
  return basedata_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
