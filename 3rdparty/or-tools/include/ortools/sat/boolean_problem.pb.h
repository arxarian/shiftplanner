...
class LinearBooleanConstraint final :
 ...
 public:
  ...
  explicit constexpr LinearBooleanConstraint(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class LinearObjective final :
 ...
 public:
  ...
  explicit constexpr LinearObjective(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class BooleanAssignment final :
 ...
 public:
  ...
  explicit constexpr BooleanAssignment(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class LinearBooleanProblem final :
 ...
 public:
  ...
  explicit constexpr LinearBooleanProblem(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void LinearBooleanProblem::set_allocated_objective(::operations_research::sat::LinearObjective* objective) {
  ...
  if (objective) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::LinearObjective>::GetOwningArena(objective);
...
inline void LinearBooleanProblem::set_allocated_assignment(::operations_research::sat::BooleanAssignment* assignment) {
  ...
  if (assignment) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::operations_research::sat::BooleanAssignment>::GetOwningArena(assignment);
    if (message_arena != submessage_arena) {
