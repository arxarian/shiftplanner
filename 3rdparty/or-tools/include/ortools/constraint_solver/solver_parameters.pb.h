...
class ConstraintSolverParameters final :
 ...
 public:
  ...
  explicit constexpr ConstraintSolverParameters(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void ConstraintSolverParameters::set_profile_file(ArgT0&& arg0, ArgT... args) {
 ...
 profile_file_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ConstraintSolverParameters::_internal_set_profile_file(const std::string& value) {
  ...
  profile_file_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ConstraintSolverParameters::_internal_mutable_profile_file() {
  
  return profile_file_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ConstraintSolverParameters::release_profile_file() {
  ...
  return profile_file_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
