...
class FirstSolutionStrategy final :
 ...
 public:
  ...
  explicit constexpr FirstSolutionStrategy(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class LocalSearchMetaheuristic final :
 ...
 public:
  ...
  explicit constexpr LocalSearchMetaheuristic(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
