...
class DemonRuns final :
 ...
 public:
  ...
  ~DemonRuns() override;
  explicit constexpr DemonRuns(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class ConstraintRuns final :
 ...
 public:
  ...
  explicit constexpr ConstraintRuns(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
void DemonRuns::set_demon_id(ArgT0&& arg0, ArgT... args) {
 ...
 demon_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void DemonRuns::_internal_set_demon_id(const std::string& value) {
  ...
  demon_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* DemonRuns::_internal_mutable_demon_id() {
  
  return demon_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* DemonRuns::release_demon_id() {
  // @@protoc_insertion_point(field_release:operations_research.DemonRuns.demon_id)
  return demon_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
void ConstraintRuns::set_constraint_id(ArgT0&& arg0, ArgT... args) {
 ...
 constraint_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void ConstraintRuns::_internal_set_constraint_id(const std::string& value) {
  ...
  constraint_id_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* ConstraintRuns::_internal_mutable_constraint_id() {
  
  return constraint_id_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* ConstraintRuns::release_constraint_id() {
  ...
  return constraint_id_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
