...
class BopOptimizerMethod final :
 ...
 public:
  ...
  explicit constexpr BopOptimizerMethod(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class BopSolverOptimizerSet final :
 ...
 public:
  ...
  explicit constexpr BopSolverOptimizerSet(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class BopParameters final :
 ...
 public:
  ...
  explicit constexpr BopParameters(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline const std::string& BopParameters::default_solver_optimizer_sets() const {
  ...
  if (default_solver_optimizer_sets_.IsDefault(nullptr)) return _i_give_permission_to_break_this_code_default_default_solver_optimizer_sets_.get();
...
void BopParameters::set_default_solver_optimizer_sets(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000001u;
 default_solver_optimizer_sets_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void BopParameters::_internal_set_default_solver_optimizer_sets(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  default_solver_optimizer_sets_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::NonEmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* BopParameters::_internal_mutable_default_solver_optimizer_sets() {
  _has_bits_[0] |= 0x00000001u;
  return default_solver_optimizer_sets_.Mutable(::operations_research::bop::BopParameters::_i_give_permission_to_break_this_code_default_default_solver_optimizer_sets_, GetArenaForAllocation());
}
inline std::string* BopParameters::release_default_solver_optimizer_sets() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return default_solver_optimizer_sets_.ReleaseNonDefault(nullptr, GetArenaForAllocation());
}
inline void BopParameters::set_allocated_default_solver_optimizer_sets(std::string* default_solver_optimizer_sets) {
  ...
  default_solver_optimizer_sets_.SetAllocated(nullptr, default_solver_optimizer_sets,
