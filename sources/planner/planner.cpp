...
void Planner::ScheduleRequestsSat()
{
    ...
    //        const qint32 dayOfWeek = date.dayOfWeek() - 1;
    ...
    //            else
    //            {
    //                cp_model.AddLessOrEqual(shiftLimits.at(dayOfWeek).minimal, LinearExpr::Sum(x));
    //                cp_model.AddLessOrEqual(LinearExpr::Sum(x), shiftLimits.at(dayOfWeek).maximal);
    //            }
    //        }
    //    }
